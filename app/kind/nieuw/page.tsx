...
export default function NieuwKindPage() {
  ...
  useEffect(() => {
    store.getHuidigeOuder().then((o) => {
      if (!o) router.push('/inloggen');
      else setOuder(o);
    });
  }, [router]);
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLaden(true);
    await store.voegKindToe(naam.trim(), leeftijdNum, groepNum, kleur);
